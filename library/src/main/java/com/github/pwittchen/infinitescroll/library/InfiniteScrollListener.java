...
public abstract class InfiniteScrollListener extends RecyclerView.OnScrollListener {
  ...
  static final String TAG = "InfiniteScroll";
  ...
  protected boolean canLoadMoreItems() {
    ...
    Log.v(TAG,"visibleItemsCount"+visibleItemsCount+" \n totalItemsCount"+totalItemsCount+" \n pastVisibleItemsCount"+pastVisibleItemsCount);
    Log.v(TAG,"lastItemShown && totalItemsCount >= maxItemsPerRequest"+(lastItemShown && totalItemsCount >= maxItemsPerRequest));
